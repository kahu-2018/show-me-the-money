  ...
  render() {
    ...
    return (
      <form className="Register form box" onSubmit={this.submit}>
        ...
        <div className= "columns">
          <label className="column is-6 is-offset-one-quarter label is-large has-text-centered">Hourly Wage
            <input required className="input is-large has-text-centered is-fullwidth" placeholder="Hourly Wage" type="number" min="0.00" name="hourly_wage" onChange={this.updateDetails}/>
          </label>
        </div>
